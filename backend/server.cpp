...
void actor_thread(std::string db, std::string host, std::string username, std::string password, int  db_port, int api_port)
{
	...
	conn.connect(db.c_str(), host.c_str(), username.c_str(), password.c_str(), db_port);
...
void sensor_thread(std::string db, std::string host, std::string username, std::string password, int db_port, int api_port)
{
	...
	if(!conn.connect(db.c_str(), host.c_str(), username.c_str(), password.c_str(), db_port))
	{
...
int main(int argc, char*argv[])
{
	...
	mysqlpp::Connection conn;
	conn.connect(db.c_str(), host.c_str(), username.c_str(), password.c_str(), port);
